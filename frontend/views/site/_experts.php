...
<div class="row">
    ...
    <div class="col-xs-8">
        ...
        <div class="desc expert" style="border-bottom: 0px;"><a href="<?= Url::toRoute(['expert/view', 'slug' => 'hrulev']) ?>">Стаж работы по специальности "Двигатели внутреннего сгорания" – 29 лет, из них экспертом – 11 лет. Руководит цехом Специализированного моторного центра "АБ-Инжиниринг", является начальником Бюро моторной экспертизы и гендиректором ООО «АБ-Эксперт».</a>
        </div>
    </div><!-- .col-md-8 -->
</div><!-- .row -->
